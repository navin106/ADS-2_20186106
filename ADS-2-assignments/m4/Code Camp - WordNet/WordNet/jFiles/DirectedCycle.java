...
public class DirectedCycle {
     ...
     */
    public DirectedCycle(final Digraph grp) {
        marked  = new boolean[grp.V()];
        onStack = new boolean[grp.V()];
        edgeTo  = new int[grp.V()];
     ...
     */
    private void dfs(final Digraph grp, final int v) {
        onStack[v] = true;
        marked[v] = true;
        for (int w : grp.adj(v)) {
